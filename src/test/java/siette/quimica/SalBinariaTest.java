...
public class SalBinariaTest extends TestCase {

    public SalBinariaTest( String testName ) {
        super( testName );
    }
    public static Test suite() {
        return new TestSuite( SalBinariaTest.class );
    }
    ...
    public void testApp() {
		...
		for(int i=0; i<100; i++) {
			Compuesto c = SalBinaria.random(tablaPeriodica);
			// c = SalBinaria.analizar("U4C5"); 
